...
let myArray = ["sting", true, 100, [5, "hello", false]];
...
let orig6 = `Toronto Maple Leafs, Chicago Black Hawks, Detroit Red Wings, Boston Bruins, Montral Canadiens, New York Rangers`;
